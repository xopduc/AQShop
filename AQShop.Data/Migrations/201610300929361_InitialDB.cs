    ...
    public partial class InitialDB : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ID)
                .ForeignKey("dbo.OrderDetails", t => new { t.OrderDetail_OrderID, t.OrderDetail_ProductID })
                .Index(t => new { t.OrderDetail_OrderID, t.OrderDetail_ProductID });
